...
export const Route = createFileRoute("/knowledge")({
  head: () => ({ meta: [{ title: "Knowledge Base — Infrastructure Agent" }, { name: "description", content: "Knowledge sources." }] }),
    ...
    <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">Knowledge management will be available soon.</p>
        </div>
      </div>
    </div>
  );
