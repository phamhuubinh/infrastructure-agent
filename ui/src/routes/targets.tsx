...
export const Route = createFileRoute("/targets")({
  head: () => ({ meta: [{ title: "Targets — Infrastructure Agent" }, { name: "description", content: "Managed targets." }] }),
    ...
    <div className="flex-1 min-w-0 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">Target management will be available soon.</p>
        </div>
      </div>
    </div>
  );
